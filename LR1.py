...
# Подключение к бд
app = Flask(__name__)
conn = psycopg2.connect(dbname='Sheniyazow_LR1', user='postgres',
                        password='postgres', host='localhost')
c = conn.cursor()
conn.commit()

# endpoint добавления региона
...
# endpoint добавления объекта налогооблажения
...
# endpoint добавления автомобиля
...
# endpoint получения информации об автомобиле
